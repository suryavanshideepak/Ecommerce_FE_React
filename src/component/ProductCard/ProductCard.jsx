                ...
                <div className="d-flex justify-content-center row">
                    <div className="col-md-10">
                        ...
                        <div className="row p-2 bg-white border rounded mt-2">
                            <div className="col-md-3 mt-1"><img alt='image2' className="img-fluid img-responsive rounded product-image" src="https://i.imgur.com/JvPeqEF.jpg" /></div>
                            <div className="col-md-6 mt-1">
                        ...
                        <div className="row p-2 bg-white border rounded mt-2">
                            <div className="col-md-3 mt-1"><img alt='image3' className="img-fluid img-responsive rounded product-image" src="https://i.imgur.com/Bf4dIaN.jpg" /></div>
                            <div className="col-md-6 mt-1">
                                ...
                                <div className="mt-1 mb-1 spec-1"><span>100% cotton</span><span className="dot"></span><span>Light weight</span><span className="dot"></span><span>Best finish<br /></span></div>
                                <div className="mt-1 mb-1 spec-1"><span>Unique design</span><span className="dot"></span><span>For men</span><span className="dot"></span><span>Casual<b /></span></div>
                                <p className="text-justify text-truncate para mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.<br /><br /></p>
                            </div>
                            <div className="align-items-center align-content-center col-md-3 border-left mt-1">
                                <div className="d-flex flex-row align-items-center">
                        ...
                        <div className="row p-2 bg-white border rounded mt-2">
                            <div className="col-md-3 mt-1"><img alt='image4' className="img-fluid img-responsive rounded product-image" src="https://i.imgur.com/HO8e9b8.jpg" /></div>
                            <div className="col-md-6 mt-1">
